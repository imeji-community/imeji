...
public class AlbumListParameters
{
    ...
    private SortParameterType sortBy = null;
    ...
    /**
     * Constructor for {@link AlbumListParameters}
     * @param state state of the albums of the list.
     * @param sortBy sort value of the list.
     * @param orderBy order value of the list.
     * @param show number of albums of the list
     * @param page page number of the list
     */
    public AlbumListParameters(String state, SortParameterType sortBy, OrderParameterType orderBy, int show, int page, String creatorId, String mdSearch)
    {
        this();
        this.state = state;
        this.sortBy = sortBy;
    ...
    /**
     * Clone the {@link AlbumListParameters}.
     */
    public AlbumListParameters clone()
    {
        AlbumListParameters clone = new AlbumListParameters(this.state, this.sortBy, this.orderBy, this.show, this.page, this.creator, this.mdSearch);
     ...
     * @return
     */
    public String getParamtersAsSearchQuery()
    {
...
//          }
    ...
    {
        String filter = "<param>" + "" +
        "<filter name=\"http://escidoc.de/core/01/structural-relations/context\">" +
            context +
        "</filter>" +
        "<filter name=\"http://escidoc.de/core/01/structural-relations/content-model\">"  + 
            contentModel +
        "</filter>";
