...
public class Page implements Serializable
{
	...
	{
		IMAGES("Images.xhtml", "history_images"), COLLECTION_IMAGES("CollectionBrowse.xhtml", "history_images_collection"), SEARCH("SearchAdvanced.xhtml", "history_advanced_search"),
