package de.mpg.imeji.vo.list.util;
...
public class ListParameters
{
     ...
     */
    public ListParameters(String state, SortParameterType sortBy, OrderParameterType orderBy, int show, int page, String creatorId, String mdSearch)
    {
        this();
        this.state = state;
        this.sortBy = sortBy;
     ...
     */
    public ListParameters clone()
    {
        ListParameters clone = new ListParameters(this.state, this.sortBy, this.orderBy, this.show, this.page, this.creator, this.mdSearch);
