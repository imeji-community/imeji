...
public class ImageController extends ImejiController{
    ...
    public void create(Image img, URI coll) throws Exception
    {
        ...
        base.begin();
        Resource r = bean2RDF.saveDeep(img);
        img = rdf2Bean.load(Image.class, r.getURI());
    ...
    public Collection<Image> search(User user, List<SearchCriterion> scList, SortCriterion sortCri, int limit,
    ...
    public static void main(String[] arg) throws Exception
    {
        ...
        for (int j = 0; j < 2; j++)
        {
            ...
            for (int i = 0; i < 10; i++)
            {
                ...
                Image im = new Image();
                im.getMetadata().add(
                        new ImageMetadata("http://purl.org/dc/elements/1.1/", "description",
                                "Test description for image in collection " + j + ", image " + i));
