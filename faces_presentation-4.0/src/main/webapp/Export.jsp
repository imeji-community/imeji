...
<jsp:output doctype-root-element="html"
	...
	<f:view locale="#{SessionBean.locale}" xmlns:e="http://www.escidoc.de/jsf">
		...
		<html xmlns="http://www.w3.org/1999/xhtml">
			...
			<body lang="#{SessionBean.locale}" onload="setRendering();">
				...
				<h:form id="formular">
					<div class="full wrapper">
						...
						<jsp:directive.include file="headerPages/Header.jspf" />
								...
								<div class="clear">
									<div class="headerSection">
										...
										<div id="contentSkipLinkAnchor" class="clear headLine">
											...
											<h1>
												<h:outputText value="Export #{AlbumList.viewAlbum.mdsFacesContainer.name}"/>
											</h1>
											<!-- Headline ends here -->
										</div>
									</div>
									<div class="small_marginLIncl subHeaderSection">
										...
										<h:panelGroup layout="block" styleClass="subHeader">
											<h:outputText  value="Please Note: At the moment it is only possible to donwload a maximum of 1000 pictures. We apologize for any inconvenience." />
										</h:panelGroup>
							...
							<jsp:directive.include file="exportPages/ExportFormular.jspf" />
