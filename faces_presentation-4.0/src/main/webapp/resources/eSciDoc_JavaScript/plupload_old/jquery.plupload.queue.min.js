...
//								if(j.files[i].status == plupload.DONE ? true : false){
//									s= s +1;
//									sName += j.files[i].name + ";" ;
//								}else{
//									f = f +1;
//									fName += j.files[i].name + ";";
//								}
//							}
//							alert(f + " files failed: " + fName + " " + s + " files uploaded successfully: " + sName);
//							window.location.href = "/faces/upload?s=" + s + "&sName=" + sName + "&f=" + f + "&fName=" + fName;
//							window.location.href = document.URL + "?done=1&totalNum=" + j.files.length;
