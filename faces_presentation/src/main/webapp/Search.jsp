	...
	<f:view locale="#{SessionBean.locale}" xmlns:e="http://www.escidoc.de/jsf">
		...
		<html xmlns="http://www.w3.org/1999/xhtml">
			...
			<body lang="#{SessionBean.locale}">
				...
				<h:outputText value="#{Search.init}" />
				<h:form id="formular">
					<div class="full wrapper">
						...
						<jsp:directive.include file="headerPages/Header.jspf" />
								...
								<div class="clear">
									<div class="headerSection">
										...
										<div id="contentSkipLinkAnchor" class="clear headLine">
											...
											<h1>
												<h:outputText value="#{msg.search_formular_headline}"></h:outputText>
											</h1>
											<!-- Headline ends here -->
										</div>
									</div>
							...
							<jsp:directive.include file="searchPages/SearchFormularGeneric.jspf" />
