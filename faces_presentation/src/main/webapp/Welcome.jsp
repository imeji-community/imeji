				...
				<!-- begin: content section (including elements that visualy belong to the header (breadcrumb, headline, subheader and content menu)) -->
					...
					<div class="full_area0">
						<div class="full_area0 infoPage">
							...
							<h:panelGroup styleClass="half_area0_p8 mainSection">
								<h:outputText value="#{StaticContent.homeContent}" escape="false"></h:outputText>
							</h:panelGroup>

							<!-- Side Panels -->
							<h:panelGroup styleClass="sideSectionArea">
								<h:panelGroup styleClass="free_area0_p8 sideSection">
									<jsp:directive.include file="homePages/BlogIntegration.jspf" />
								</h:panelGroup>
							</h:panelGroup>
