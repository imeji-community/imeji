...
public class SearchIndex
{
    ...
    {
        uri, my, prop, creator, editor, created, modified, status, grant, grantType, grantFor, filename, visibility, mdSet, col, prof, rdfType, cont_md, cont_title, 
        ...
        md, statement, all, text, number, date, time, title, longitude, latitude, license, link, label, citation, citationStyle, cone, 
