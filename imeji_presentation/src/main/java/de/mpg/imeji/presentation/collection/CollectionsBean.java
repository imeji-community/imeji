	...
	public List<CollectionListItem> retrieveList(int offset, int limit) throws Exception
	{
		...
		if (!"".equals(query))
		{
			if (query.startsWith("\"") && query.endsWith("\""))
			{
				...
				scList.add(new SearchCriterion(Operator.OR, SearchIndexes.CONTAINER_METADATA_DESCRIPTION, query, Filtertype.REGEX));
				scList.add(new SearchCriterion(Operator.OR, SearchIndexes.CONTAINER_METADATA_PERSON_FAMILY_NAME, query, Filtertype.REGEX));
				scList.add(new SearchCriterion(Operator.OR, SearchIndexes.CONTAINER_METADATA_PERSON_GIVEN_NAME, query, Filtertype.REGEX));
				scList.add(new SearchCriterion(Operator.OR, SearchIndexes.CONTAINER_METADATA_PERSON_COMPLETE_NAME, query, Filtertype.REGEX));
				scList.add(new SearchCriterion(Operator.OR, SearchIndexes.CONTAINER_METADATA_PERSON_ORGANIZATION_NAME, query, Filtertype.REGEX));
			...
			else
			{
				for (String s : query.split("\\s"))
				{
					...
					scList.add(new SearchCriterion(Operator.OR, SearchIndexes.CONTAINER_METADATA_DESCRIPTION, s, Filtertype.REGEX));
					scList.add(new SearchCriterion(Operator.OR, SearchIndexes.CONTAINER_METADATA_PERSON_FAMILY_NAME, s, Filtertype.REGEX));
					scList.add(new SearchCriterion(Operator.OR, SearchIndexes.CONTAINER_METADATA_PERSON_GIVEN_NAME, s, Filtertype.REGEX));
					scList.add(new SearchCriterion(Operator.OR, SearchIndexes.CONTAINER_METADATA_PERSON_ORGANIZATION_NAME, s, Filtertype.REGEX));
