...
public class SelectedBean extends ImagesBean implements Serializable
{
    ...
    {
        return new SearchResult(getSelectedUris(), new SortCriterion());
    }
    ...
    public String removeFromAlbum() throws Exception
    {
        ...
        SearchResult results = new SearchResult(getSelectedUris(), new SortCriterion());
        ...
        if (bean.getAlbum() != null && bean.getAlbum().getAlbum() != null)
        {
            ...
            if (activeAlbum != null
                    && activeAlbum.getAlbum().getId().toString().equals(bean.getAlbum().getAlbum().getId().toString()))
            {
