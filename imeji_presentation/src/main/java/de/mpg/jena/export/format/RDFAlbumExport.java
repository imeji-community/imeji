...
/**
 * Export in a pretty RDF (without technical triples) of albums
 * 
 * @author Friederike Kleinfercher
 *
 */
public class RDFAlbumExport extends Export
{
	...
	private void exportIntoOut(SearchResult sr, OutputStream out)
	{
		...
		{
			Resource resource = ImejiJena.albumModel.getResource(s);
			newLine(writer);
