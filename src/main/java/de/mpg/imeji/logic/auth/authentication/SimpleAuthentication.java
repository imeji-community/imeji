...
public class SimpleAuthentication extends Authentication
{
    /*
     * (non-Javadoc)
     * @see de.mpg.imeji.logic.aai.Authentication#login(java.lang.String, java.lang.String)
     */
    @Override
    ...
    /*
     * (non-Javadoc)
     * @see de.mpg.imeji.logic.aai.Authentication#logout(de.mpg.imeji.logic.vo.User)
     */
    @Override
