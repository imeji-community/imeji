...
public class AuthorizationPredefinedRoles
{
    ...
    public static List<Grant> editContainer(String containerUri, String profileUri)
    {
    ...
    {
        return profileUri != null ? toGrantList(edit_profile, profileUri) : new ArrayList<Grant>();
    }
