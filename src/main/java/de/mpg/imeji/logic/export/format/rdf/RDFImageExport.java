...
public class RDFImageExport extends RDFExport {
	...
	private String[] filteredTriples = { "http://imeji.org/terms/metadata/pos",
			...
			"http://imeji.org/terms/metadata/id", "http://imeji.org/terms/id",
			"http://imeji.org/terms/metadata/searchValue",
			"http://purl.org/escidoc/metadata/profiles/0.1/pos",
			"http://imeji.org/terms/fulltext", ImejiNamespaces.CREATOR,
			ImejiNamespaces.MODIFIED_BY, ImejiNamespaces.METADATA };
	...
	protected void initNamespaces() {
		...
		super.namespaces.put("http://purl.org/escidoc/metadata/terms/0.1/",
				"eterms");
		super.namespaces.put("http://purl.org/dc/elements/1.1/", "dc");
		super.namespaces.put("http://purl.org/dc/terms/", "dcterms");
		super.namespaces.put("http://purl.org/escidoc/metadata/profiles/0.1/",
				"eprofiles");
	...
	/*
	 * Not implemented : needs of specification about restricted metadata (how
	 * to make it really private...)
	 * 
	 * @see
	 * de.mpg.imeji.logic.export.format.RDFExport#filterResources(de.mpg.imeji
