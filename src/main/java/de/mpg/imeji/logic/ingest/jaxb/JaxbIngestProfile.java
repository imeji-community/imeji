        ...
        IJaxbMetadataProfiles, IJaxbIngestProfile
{
    ...
    @Override
    public void marshalMdProfile(File xmlFile, MetadataProfile mdp) throws JAXBException, SAXException,
            FileNotFoundException
    {
        String xsdFilename = IJaxbMetadataProfile.xsdFilename;
        if (xsdFilename == null || xsdFilename.isEmpty())
    ...
    @Override
    public void marshalMdProfiles(String xmlFilename, MetadataProfiles mdps) throws JAXBException, SAXException,
            FileNotFoundException
    {
    ...
    @Override
    public void marshalMdProfiles(File xmlFile, MetadataProfiles mdps) throws JAXBException, SAXException,
            FileNotFoundException
    {
        String xsdFilename = IJaxbMetadataProfiles.xsdFilename;
        if (xsdFilename == null || xsdFilename.isEmpty())
