...
/**
 * Job to import files from escidoc to the internal storage. This is used when
 * you want to switch the storage from escidoc to internal
 * 
 * @author saquet
 *
 */
public class ImportFileFromEscidocToInternalStorageJob implements
		Callable<Integer> {

	private static Logger logger = Logger
			.getLogger(ImportFileFromEscidocToInternalStorageJob.class);
	private User user;
