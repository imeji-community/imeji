...
public enum ElasticFields {
  ID, NAME, DESCRIPTION, SPACE, COLLECTIONSINSPACE, STATUS, LASTEDITOR, CREATOR, CREATED, MODIFIED, MEMBER, FILETYPE, SIZE, FOLDER, PROFILE, ALBUM, CHECKSUM, FILENAME, METADATA, METADATA_TEXT(
