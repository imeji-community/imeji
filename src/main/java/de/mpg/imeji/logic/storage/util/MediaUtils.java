...
public class MediaUtils {
	...
	public static void resizeImage(String orginalType, String orginalPath,
			String targetPath, FileResolution resolution, String mimeType)
