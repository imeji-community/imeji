      ...
      if (s.getParent() != null) {
        ...
        if (i == 0) {
          ...
          if (parentStatement.getId().equals(preStatement.getId())
             ...
             * else if(!parentStatement.getId().equals(preStatement.getId()) &&
             * !s.getId().equals(preStatement.getId()) && !isSuccessor(s, preStatement, p)){ throw
             * new UnprocessableError(parentStatement.getLabel() + " has to be filled"); }
             */
        }
