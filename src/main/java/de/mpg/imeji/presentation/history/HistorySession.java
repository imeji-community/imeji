...
public class HistorySession {
	...
	/**
	 * Remove {@link HistoryPage} of the history, when the size of the history
	 * is greater thant the maximum size
	 */
	...
	/**
	 * Remove a {@link HistoryPage} of the history according to its position in
	 * the history
	 * 
	 * @param pos
	 */
	...
	public HistoryPage getPreviousPage() {
		if (!pages.isEmpty()) {
			return pages.size() > 2 ? pages.get(pages.size() - 2) : pages
					.get(0);
		}
		return null;
	}
