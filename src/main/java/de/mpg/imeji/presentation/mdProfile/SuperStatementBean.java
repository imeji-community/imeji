...
public class SuperStatementBean implements Comparable<SuperStatementBean>{

	private int pos = 0;

	private SuperStatementBean parent = null;
	...
	public SuperStatementBean(Statement statement) {
		this.preview = statement.isPreview();
		this.statement = statement;
	}

	public SuperStatementBean copy() {
		SuperStatementBean copy = new SuperStatementBean(statement);
	 ...
	 */
	public SuperStatementBean copyEmpty() {
		SuperStatementBean copy = new SuperStatementBean(statement);
		copy.setParent(parent);
		copy.setTreeIndex(treeIndex);
		return copy;
	 ...
	 *            the parent to set
	 */
	public void setParent(SuperStatementBean parent) {
		this.parent = parent;
	}
	 ...
	 * @return the parent
	 */
	public SuperStatementBean getParent() {
		return parent;
	}
	...
	@Override
	public int compareTo(SuperStatementBean o) {
	...
	public SuperStatementBean lastParent() {
		SuperStatementBean ssb = this;
		while (ssb.getParent() != null) {
			ssb = ssb.getParent();
		}
		return ssb;
	}
