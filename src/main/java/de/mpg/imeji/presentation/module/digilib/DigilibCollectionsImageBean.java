 ...
 */
public class DigilibCollectionsImageBean extends DigilibImagesBean
{
    ...
    public DigilibCollectionsImageBean() throws Exception
    {
        super();
    ...
    {
        return "pretty:DegilibCollectionsItem";
    }
}
