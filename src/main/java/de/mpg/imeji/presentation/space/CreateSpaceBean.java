    ...
    public boolean createdSpace(){
    	...
    	if(logoFile != null)
    	{
    		try {
	    		...
	    		tmpFile = File.createTempFile("spaceLogo", "." + Files.getFileExtension(logoFile.getName()), tmpPath);
    	...
    	try {
			...
			Collection<String> collections = new ArrayList<String>(selectedCollections);
	    	URI uri = spaceController.create(space, collections, tmpFile, sessionBean.getUser());
