...
public class Scripts
{
    public String copyDataFromCoreToCore(User admin)
    {
        ...
        //
        // String userHandle = LoginHelper.login(PropertyReader.getProperty("imeji.escidoc.user"),
        ...
        // try
        // {
        // GetMethod getImage = loadImage(oldCoreserviceUrl,
        // image.getFullImageUrl().toString().replace("http://dev-coreservice.mpdl.mpg.de:80", oldCoreserviceUrl),
        // userHandleOldFW);
        //
        ...
        // String itemXml =
        // ServiceLocator.getItemHandler(userHandle).create(item.getItemDocument().xmlText().replaceAll("escidoc:faces40",
        // PropertyReader.getProperty("escidoc.faces.content-model.id")));
        ...
        // {
        // if
        // (c.getContentCategory().equals(PropertyReader.getProperty("xsd.metadata.content-category.original-resolution")))
        // {
        ...
        // }
        // if
        // (c.getContentCategory().equals(PropertyReader.getProperty("xsd.metadata.content-category.web-resolution")))
        // {
    ...
    {
        LoginHelper.loginInEscidoc("roland", "topor");
    }
