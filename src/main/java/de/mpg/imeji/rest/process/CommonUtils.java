...
public class CommonUtils {
  ...
  public static final String FILENAME_RENAME_EMPTY =
      "Type a new filename if you want to rename it.";
  public static final String FILENAME_RENAME_INVALID_SUFFIX = "Invalid suffix.";
  public static final String JSON_Invalid =
      "Malformed json body in the request. Check the JSON body for correctness.";
