...
public class ItemResource implements ImejiResource {
  ...
  @ApiOperation(
      ...
      notes = "Update an already existed item. Both the item metadata and the item file can be updated. File can be defined either as (by order of priority):"
           ...
           * + "<br/>\"metadata\" : " + "<br/>{"
           * 
           * + "<br/>\"TEXT_LABEL\" : \"abc123\"," + "<br/>\"NUMBER_LABEL\" : nr," +
           * "<br/>\"DATE_LABEL\" : \"YYYY-MM-DD\","
           * 
           * + "<br/>\"PERSON_LABEL\" : " + "<br/>{" + "<br/>\"familyName\": \"familyname...\"," +
           * "<br/>\"givenName\" : \"givenname...\"" + "<br/>},"
           * 
           * + "<br/>\"GEOLOCATION_LABEL\" : " + "<br/>{" + "<br/>\"name\": \"name...\"," +
           * "<br/>\"longitude\" : longitude...," + "<br/>\"latitude\" : latitude..." + "<br/>},"
           * 
           * + "<br/>\"LICENSE_LABEL\" : " + "<br/>{" + "<br/>\"license\": \"license...\"," +
           * "<br/>\"url\" : \"license url...\"" + "<br/>},"
           * 
           * + "<br/>\"LINK_LABEL\" : " + "<br/>{" + "<br/>\"link\": \"link...\"," +
           * "<br/>\"url\" : \"link url...\"" + "<br/>},"
           * 
           * + "<br/>\"PUBLICATION_LABEL\" : " + "<br/>{" + "<br/>\"format\": \"format...\"," +
           * "<br/>\"publication\" : \"publication...\"," + "<br/>\"citation\" : \"citation...\"" +
           * "<br/>}"
           * 
           * + "<br/>}"
           */
   ...
   * @Path("/{id}")
   * 
   * @ApiOperation( value = "Easy Update Item Metadata by id", notes =
   * "Update Metadata of an already existing item:" + "<br/><br/>" + "Json example:" +
   * "<div class=\"json_example\">" + "{"
   * 
   * + "<br/>\"metadata\":" + "<br/>{"
   * 
   ...
   * 
   * + "<br/>\"PUBLICATION_LABEL\" : " + "<br/>{" + "<br/>\"format\": \"format...\"," +
   * "<br/>\"publication\" : \"publication...\"," + "<br/>\"citation\" : \"citation...\"" + "<br/>}"
   * 
   * + "<br/>}"
   * 
   * + "<br/>}" + "</div>" + "<br/><br/>" +
