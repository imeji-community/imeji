...
public class LogoutResource {
  ...
  @ApiOperation(value = "Logout from the API",
      notes = "Current User (according to authorization header) will be logout: API Key will be invalidate. User will need to login with Basic Authentication to get a new Key")
