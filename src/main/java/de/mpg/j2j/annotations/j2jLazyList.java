 ...
 * - A lazy {@link List} should be defined for all {@link List} which might get huge. To avoid some READ or WRITE
 * operations to last too long, it is preferable to avoid such lists<br/>
