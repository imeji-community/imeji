 ...
 * directly, use {@link JenaWriter} of {@link JenaReader} instead
 * 
...
public class ResourceController {
	...
	/**
	 * Use for transaction. The model must have been created/retrieved within
	 * the transaction
	 * 
	 * @param model
	 * @param lazy
	...
	public void create(Object o) throws AlreadyExistsException {
		if (java2rdf.exists(o)) {
			throw new AlreadyExistsException("Error creating resource "
					+ J2JHelper.getId(o) + ". Resource already exists! ");
		}
		java2rdf.write(o);
	}
	...
	public Object read(Object o) throws NotFoundException {
		if (!java2rdf.exists(o)) {
			throw new NotFoundException("Resource " + J2JHelper.getId(o)
					+ " not found!");
		}
	...
	public void update(Object o) throws NotFoundException {
		if (!java2rdf.exists(o)) {
			throw new NotFoundException("Error updating resource "
					+ o.toString() + " with id \"" + J2JHelper.getId(o)
					+ "\". Resource doesn't exists in model "
					+ model.toString());
		}
		java2rdf.update(o);
	}
	...
	public void delete(Object o) throws NotFoundException {
		if (!java2rdf.exists(o)) {
			throw new NotFoundException("Error deleting resource "
					+ J2JHelper.getId(o) + ". Resource doesn't exists! ");
		}
		java2rdf.remove(o);
	}
