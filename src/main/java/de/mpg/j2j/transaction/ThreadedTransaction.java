...
public class ThreadedTransaction implements Callable<Integer> {
	...
	protected static Logger logger = Logger
			.getLogger(ThreadedTransaction.class);
	...
	public Integer call() throws Exception {
		Dataset ds = Imeji.tdbPath != null ? TDBFactory
				.createDataset(Imeji.tdbPath) : TDBFactory.createDataset();
		try {
	...
	/**
	 * Run a {@link ThreadedTransaction} with the {@link ExecutorService} of
	 * imeji
	 * 
	 * @param t
	 * @throws Exception
