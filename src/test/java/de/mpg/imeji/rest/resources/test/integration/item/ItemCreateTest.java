...
public class ItemCreateTest extends ItemTestBase {
	...
	public static final File TEST_PNG_FILE = new File(
	...
	@Test
	public void createItemWithFile_NullAsExtensionInFileUrl_Bug1023()
			throws IOException {
		initCollection();
		FileDataBodyPart filePart = new FileDataBodyPart("file", new File(
				"src/test/resources/storage/test"));
		FormDataMultiPart multiPart = new FormDataMultiPart();
		multiPart.bodyPart(filePart);
		multiPart.field(
				"json",
	...
	public void createItemWithoutFilename() throws IOException {
		...
		assertThat("File name is wrong", item.getFilename(), equalTo(filePart
	...
	public void createItemInNotExistingCollection() throws IOException {
		...
		multiPart.field(
				"json",
				itemJSON.replace("___COLLECTION_ID___",
	...
	public void createItem_InReleasedCollection() throws Exception {
		...
		assertEquals("RELEASED", sc.read(collectionId, JenaUtil.testUser)
				.getStatus());
	...
	public void createItem_InWithdrawnCollection() throws Exception {
		...
		assertEquals("RELEASED", sc.read(collectionId, JenaUtil.testUser)
				.getStatus());
		sc.withdraw(collectionId, JenaUtil.testUser,
				"ItemCreateTest_createItem_InWithdrawnCollection");
	...
	public void createItem_SyntaxInvalidJSONFile() throws Exception {
		...
		multiPart.field(
				"json",
				wrongJSON.replace("___COLLECTION_ID___", collectionId).replace(
						"___FILENAME___", "test.png"));
	...
	@Test
	public void createItem_WithFile_Fetched_WithEmptyFileName()
			throws IOException {
