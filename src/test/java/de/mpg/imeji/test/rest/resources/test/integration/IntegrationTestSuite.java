...
import de.mpg.imeji.testimpl.rest.resources.item.ItemEasyUpdateMetadata;
...
@RunWith(Suite.class)
@Suite.SuiteClasses({ItemCreate.class, ItemRead.class, ItemUpdateBasic.class, ItemUpdateFile.class,
    ItemUpdateMetadata.class, ItemDelete.class, ItemDefaultMdCreate.class, ItemDefaultUpdate.class,
    ItemEasyUpdateMetadata.class, AlbumIntegration.class, CollectionIntegration.class,
