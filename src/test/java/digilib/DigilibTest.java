...
public class DigilibTest
{
    ...
    public void test() throws Exception
    {
        ...
        // //String uri =
        // "http://zuse.zib.de/imeji/coreserviceimage?imageUrl=http%3A//localhost%3A8080/ir/item/escidoc%3A9510/components/component/escidoc%3A9508/content";
        // String uri = "src/test/resources/digilib/cat.jpg";
        // // String uri =
        // "http://zuse2.zib.de/file/FukdvdNguPLnIsJh/93/cd/82/63-34b0-4bbd-b4b0-acc5fb16170f/0/original/514c183e2bdeb446f1e8b36c919a53b6.jpg";
        //
        // BufferedImage bim = ImageUtils.byteArrayToBufferedImage(im.getScaledImage("sessionID",uri, query));
        //
